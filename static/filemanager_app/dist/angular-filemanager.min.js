!function (e, r, n) {
    ...
    r.module("FileManagerApp", ["pascalprecht.translate", "ngFileUpload"]), n(e.document).on("shown.bs.modal", ".modal", function () {
        ...
        r.pageX >= e.innerWidth - i.width() && (r.pageX -= i.width()), r.pageY >= e.innerHeight - i.height() && (r.pageY -= i.height()), i.hide().css({
            left: r.pageX,
            top: r.pageY
        }).appendTo("body").show(), r.preventDefault()
    }), Array.prototype.find || (Array.prototype.find = function (e) {
        if(null == this) throw new TypeError("Array.prototype.find called on null or undefined");
        if("function" != typeof e) throw new TypeError("predicate must be a function");
        for (var r, n = Object(this), i = n.length >>> 0, a = arguments[1], t = 0; i > t; t++) if(r = n[t], e.call(a, r, t, n)) return r
    })
}(window, angular, jQuery), function (e, r) {
    "use strict";
    e.module("FileManagerApp").controller("FileManagerCtrl", ["$scope", "$rootScope", "$window", "$translate", "fileManagerConfig", "item", "fileNavigator", "apiMiddleware", function (e, n, i, a, t, o, s, l) {
        ...
        e.config = t, e.reverse = !1, e.predicate = ["model.type", "model.name"], e.order = function (r) {
            ...
            e.singleSelection() ? e.temp = e.singleSelection() : (e.temp = new o({rights: 644}), e.temp.multiple = !0), e.temp.revert()
            ...
            var i = e.temps.indexOf(r), a = n && 3 == n.which;
            if(n && n.target.hasAttribute("prevent")) return void (e.temps = []);
            if(!(!r || a && e.isSelected(r))) {
                if(n && n.shiftKey && !a) {
                    var t = e.fileList, o = t.indexOf(r), s = e.temps[0], l = t.indexOf(s), d = void 0;
                    if(s && t.indexOf(s) < o) {
            ...
            e.apiMiddleware.changePermissions(e.temps, e.temp).then(function () {
                e.fileNavigator.refresh(), e.modal("changepermissions", !0)
            })
        }, e.download = function () {
            var r = e.singleSelection();
            ...
            var r = e.singleSelection();
            if(r) {
                var i = r.tempModel.name.trim(), t = e.fileNavigator.fileNameExists(i);
            ...
            var r = e.temp.tempModel.name.trim(), i = e.fileNavigator.fileNameExists(r);
            ...
            var r = e.temp, i = e.temp.tempModel.name.trim(), t = e.fileNavigator.fileNameExists(i);
            ...
            var r = e.singleSelection(), n = r.tempModel.name, i = r.tempModel.path.join("") === r.model.path.join("");
            ...
            var r = e.singleSelection(), n = r.tempModel.name;
        ...
        var c = function (e) {
            var r = n.selectedModalPath.join(""), i = e && e.model.path.join("");
            return i === r
        }, p = function (e) {
    ...
    e.module("FileManagerApp").controller("ModalFileManagerCtrl", ["$scope", "$rootScope", "fileNavigator", function (e, r, n) {
        e.reverse = !1, e.predicate = ["model.type", "model.name"], e.fileNavigator = new n, r.selectedModalPath = [], e.order = function (r) {
            ...
            var n = r.selectedModalPath.filter(Boolean), i = "/" + n.join("/");
    ...
    e.module("FileManagerApp").service("apiHandler", ["$http", "$q", "$window", "$translate", "Upload", function (e, n, i, a, t) {
        ...
        return o.prototype.deferredHandler = function (e, r, n, i) {
            ...
            var o = this, s = a || o.deferredHandler, l = n.defer(),
                d = {action: "list", path: i, fileExtensions: t && t.length ? t : void 0};
            return o.inprocess = !0, o.error = "", e.post(r, d).success(function (e, r) {
                s(e, l, r)
            }).error(function (e, r) {
                s(e, l, r, "Unknown error listing, check the response")
            })["finally"](function () {
                o.inprocess = !1
            }), l.promise
        }, o.prototype.copy = function (r, i, t, o) {
            var s = this, l = n.defer(), d = {action: "copy", items: i, newPath: t};
            ...
            var o = this, s = n.defer(), l = {action: "move", items: i, newPath: t};
            ...
            var t = this, o = n.defer(), s = {action: "remove", items: i};
            ...
            var a = this, o = n.defer();
            a.inprocess = !0, a.progress = 0, a.error = "";
            for (var s = {destination: r}, l = 0; l < i.length; l++) s["file-" + l] = i[l];
            ...
            var t = this, o = n.defer(), s = {action: "getContent", item: i};
            return t.inprocess = !0, t.error = "", e.post(r, s).success(function (e, r) {
                t.deferredHandler(e, o, r)
            }).error(function (e, r) {
            ...
            var o = this, s = n.defer(), l = {action: "edit", item: i, content: t};
            return o.inprocess = !0, o.error = "", e.post(r, l).success(function (e, r) {
                o.deferredHandler(e, s, r)
            }).error(function (e, r) {
            ...
            var o = this, s = n.defer(), l = {action: "rename", item: i, newItemPath: t};
            return o.inprocess = !0, o.error = "", e.post(r, l).success(function (e, r) {
                o.deferredHandler(e, s, r)
            }).error(function (e, r) {
            ...
            var c = this, p = n.defer(), m = {action: "downloadMultiple", items: o, toFilename: s},
                u = [t, r.param(m)].join("?");
            ...
            var s = this, l = n.defer(), d = {action: "compress", items: i, destination: o, compressedFilename: t};
            ...
            var s = this, l = n.defer(), d = {action: "extract", item: i, destination: o, folderName: t};
            return s.inprocess = !0, s.error = "", e.post(r, d).success(function (e, r) {
                s.deferredHandler(e, l, r)
            }).error(function (e, r) {
            ...
            var l = this, d = n.defer(),
                c = {action: "changePermissions", items: i, perms: t, permsCode: o, recursive: !!s};
            ...
            var t = this, o = n.defer(), s = {action: "createFolder", newPath: i};
            return t.inprocess = !0, t.error = "", e.post(r, s).success(function (e, r) {
                t.deferredHandler(e, o, r)
            }).error(function (e, r) {
    ...
    e.module("FileManagerApp").service("apiMiddleware", ["$window", "fileManagerConfig", "apiHandler", function (e, r, n) {
        ...
        return i.prototype.getPath = function (e) {
            ...
            var i = this.getFileList(e), a = (new Date).getTime().toString().substr(8, 13),
